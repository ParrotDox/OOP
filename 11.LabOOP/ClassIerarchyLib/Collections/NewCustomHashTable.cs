...
namespace ClassIerarchyLib
{
    ...
    public class NewCustomHashTable<TKey, TVal> : CustomHashTable<TKey, TVal>
    {
        ...
        public override TVal this[TKey key]
        {
            ...
            set
            {
                OnCollectionRefChanged(this, new CollectionHandlerEventArgs<TVal>(this.CollectionName, $"Indexator[{key}]", value));
                base[key] = value;
            }
        }
        //Delegates & events
        ...
        {
            OnCollectionCountChanged(this, new CollectionHandlerEventArgs<TVal>(this.CollectionName, "Add", sample));
            base.Add(key, sample);
        }
        public override void Add(KeyValuePair<TKey, TVal> sample) 
        {
            OnCollectionCountChanged(this, new CollectionHandlerEventArgs<TVal>(this.CollectionName, "AddPair", sample.Value));
            base.Add(sample);
        }
        public override bool Remove(TKey key) 
        {
            OnCollectionCountChanged(this, new CollectionHandlerEventArgs<TVal>(this.CollectionName, $"Remove({key})", base[key]));
            return base.Remove(key);
        }
        public override bool Remove(KeyValuePair<TKey, TVal> pair_sample) 
        {
            OnCollectionCountChanged(this, new CollectionHandlerEventArgs<TVal>(this.CollectionName, "RemovePair", base[pair_sample.Key]));
